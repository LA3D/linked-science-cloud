...
export function validateEvidencePack(pack) {
  ...
  if (pack.access?.mode !== 'mediated-anonymous-linked-data-read' || pack.access.authorizationRequired !== true || pack.access.endpointAllowlist !== false) {
    throw new Error('Evidence pack access must use authorized mediated anonymous Linked Data read traversal without an endpoint allowlist');
  }
