...
export function validateEvidencePack(pack) {
  ...
  if (pack.access?.mode !== 'mediated-public-https-linked-data' || pack.access.authorizationRequired !== true || pack.access.endpointAllowlist !== false) {
    throw new Error('Evidence pack access must use authorized mediated public HTTPS traversal without an endpoint allowlist');
  }
