...
import {
  hasLinkedSciencePrivateResultStore,
...
export async function inspectLinkedScienceBootstrap({
  ...
  const resultStorageAvailable = hasLinkedSciencePrivateResultStore(cleanroom);
  ...
  return Object.freeze({
    ...
    resultStorage: Object.freeze({ available: resultStorageAvailable, owner: 'cleanroom-broker', exposure: 'private-runtime-only' }),
  });
}
