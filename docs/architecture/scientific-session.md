...
The [adapter-completion E2 receipt](../../artifacts/scoped-data-bridge/e2-20260909-adapters-fixed-03/receipt.json) records 48 passing checks across two repetitions in each graph/bindings storage tier, plus JSON inputs. This supersedes the earlier coverage gaps without altering those historical results. E3 scope/lifetime, E4 semantic quality and E5 scale remain separate, unrun experiments.
