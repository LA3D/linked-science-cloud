...
| --- | --- | --- | --- |
| [RLM/Prime symbolic graph realignment](rlm-symbolic-graph-realignment.md) | Active | Make RLM/Prime normative and let large RDF remain symbolic behind handles while projections stay independently bounded. | Update the plan and active documentation routes, then implement the controlled >10,000-quad acquire-once/two-query fixture. |
