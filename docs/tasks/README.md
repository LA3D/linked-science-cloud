...
| --- | --- | --- | --- |
| [UniProt orientation comparison](uniprot-orientation-comparison.md) | Inventory and plan complete; execution not started | Compare existing metadata orientation with reviewed semantic entries using existing UniProt material. | Review the development/reserved split and smallest paired comparison; see the dated reconciliation of historical gates. |
