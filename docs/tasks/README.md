...
| --- | --- | --- | --- |
| [Scoped data bridge](scoped-data-bridge.md) | Experiment design complete; unrun | Codex-owned semantic processing over typed resident objects with results returned to the REPL. | Freeze and execute E1 worker topology when requested; use its evidence to select the bridge design. |
