...
| --- | --- | --- | --- |
| [Scoped data bridge](scoped-data-bridge.md) | Shared-session core; activation pending | E1 evidence recorded; independent MCP clients access scoped native objects in a persistent session. | Finish verification, restart the desktop, and verify live session attachment. |
