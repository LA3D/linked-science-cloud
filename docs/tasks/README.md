...
| --- | --- | --- | --- |
| [Scoped data bridge](scoped-data-bridge.md) | Shared-session core; E2 passed | E1 evidence recorded; independent MCP clients access scoped native objects in a persistent session. | JSON and native RDF storage additions closed E2 gaps; E3 scope/lifetime is next. |
