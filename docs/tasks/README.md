...
| --- | --- | --- | --- |
| [UniProt competency evaluation manifest](uniprot-competency-manifest.md) | Protocol 3.0.0 live preflight partial; baseline gate closed | Preserve the leakage-audited three-case public/private split while workers use only generic mediated traversal budgets and resource roles. | Review the W3C-success/DBpedia-failure receipt and decide whether to authorize one new neutral attempt before any baseline. |
