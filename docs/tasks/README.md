...
| --- | --- | --- | --- |
| [Scoped data bridge](scoped-data-bridge.md) | Shared-session core; live activation passed | E1 evidence recorded; independent MCP clients access scoped native objects in a persistent session. | Live scoped worker round trip recorded; broader experiments remain separately scoped. |
