...
| [Reasoning integration and wiki guidance](reasoning-and-wiki-guidance.md) | Selected direction; integration planned | Connect deterministic reasoning to the shared symbolic surface, then learn when to use it from scientific episodes. | Specify the bounded reasoning adapter, prove scoped scientific use, then propose and evaluate cited wiki guidance. See the brief for acceptance gates; no reasoning memories or production API yet. |
