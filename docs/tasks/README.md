...
| [Eyeron reasoning compatibility](../experiments/eyeron-compatibility.md) | Installation and 15 small checks complete; readiness partial | Evaluate N3/SRL and explicit OWL-rule reasoning over RDF/JS. | Design graph/proof/lifetime contracts and broker-owned context transfer before production integration. |
