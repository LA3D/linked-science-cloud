...
| --- | --- | --- | --- |
| [Scoped data bridge](scoped-data-bridge.md) | Shared-session core; E2 partial | E1 evidence recorded; independent MCP clients access scoped native objects in a persistent session. | E2 graph/bindings checks passed; JSON input and named-graph storage coverage need work before a full gate pass. |
