...
| --- | --- | --- | --- |
| [UniProt orientation comparison](uniprot-orientation-comparison.md) | Inventory and plan complete; execution not started | Plan automatic source bookkeeping and agent-proposed semantic entries using existing UniProt material and a fresh second context. | Automatic plan accepted with minimal experimental/library-reuse constraints; implementation and execution have not started. |
