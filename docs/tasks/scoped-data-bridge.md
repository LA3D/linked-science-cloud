...
## 2026-09-19 live worker and endpoint examples

In the configured saved checkout `/Users/cvardema/dev/git/LA3D/agents/linked-science-cloud`, fresh mounted Codex workers and the mounted owner completed two bounded computational round trips. This was not the E5 suite and changed no runtime implementation.

- [Synthetic receipt](../../artifacts/scoped-data-bridge/live-20260919-worker-compute-01/receipt.json): 2,048 items / 4,112 retained quads; worker join produced 500 triples; owner queried the deposited native reference and verified count 500, sum 37,000 and mean 74 against an independent formula.
- [Public UniProt receipt](../../artifacts/scoped-data-bridge/live-20260919-public-worker-01/receipt.json): complete 45-triple classification slice; worker produced 36 triples for 18 shared GO terms; owner verified the exact set and calculated intersection/union 18/27. The first worker query/deposit was blocked by automatic approval review; a fresh attempt succeeded after direct user approval. Shared classifications do not establish functional equivalence.
- [Identifiers.org](../../resources/sources/identifiers-org.md) and [WikiPathways](../../resources/sources/wikipathways.md) now have reusable source notes and broker query examples. Both official documentation routes and focused endpoint reads succeeded; [dated receipts](../../artifacts/endpoint-examples/20260919/receipt.json) distinguish current observations from historical profiles.

All workers completed, evidence was captured before workspace disposal, and the isolated service was stopped without resetting the original scratch kernel. Native references are now historical identifiers, not resumable objects. Full transcript/transport accounting, general scalability and semantic model-quality claims remain unestablished. No further experiment is authorized by these records; E5 remains unrun.
