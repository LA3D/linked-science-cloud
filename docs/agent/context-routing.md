...
| Acquire documentation or traverse live Linked Data | The skill's evidence-acquisition reference, [broker-mediated traversal architecture](../architecture/broker-owned-live-operations.md), the relevant source-orientation entry, and any source-specific evidence dossier. Current explicit approval for the scientific scope and effective traversal budgets is required; dynamically discovered destinations are mediator-governed, not an allowlist. |
