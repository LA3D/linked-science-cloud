...
| Task type | Read next |
| --- | --- |
| Use or change the Linked Science RLM runtime | [Runtime discovery](runtime-discovery.md), then the normative [RLM/Prime runtime architecture](../architecture/rlm-linked-science-runtime.md), the [persistent JavaScript compatibility surface](../architecture/codeact-linked-science-runtime.md), and [ontology/schema objects](../architecture/ontology-and-schema-objects.md). |
...
| Design recursive Linked Data context management or a PEEK policy | [Prime-style context management](../architecture/prime-linked-data-context-management.md), then the staged [research plan](../../PLAN.md). Provider activation and experiment runs remain separately authorized. |
