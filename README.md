...
- **Schema affordances:** a source-backed UniProt/Rhea/Wikidata catalog lets a worker select known prefixes and official query motifs, then validate a bounded non-executing plan before it constructs a query. See the [affordance experiment](docs/experiments/affordance-catalog.md).
